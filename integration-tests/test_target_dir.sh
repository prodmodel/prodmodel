...
python3.5 -m prodmodel build integration-tests/example:csv_data
...
python3.5 -m prodmodel build integration-tests/example:csv_data --target_dir=.my_target
...
rm -rf /tmp/.target
python3.5 -m prodmodel build integration-tests/example:csv_data --target_dir=/tmp/.target
